  ...
  Environment *theEnv)
{
   ...
   AddUDF(theEnv,"get-fs-template","w",1,1,NULL,get_fs_template,"get_fs_template",NULL);
   ...
   AddUDF(theEnv,"fuzzy-union","u",2,2,NULL,(UserDefinedFunction *)fuzzy_union,"fuzzy_union",NULL);
   AddUDF(theEnv,"fuzzy-intersection","u",2,2,NULL,(UserDefinedFunction *)fuzzy_intersection,"fuzzy_intersection",NULL);
   AddUDF(theEnv,"fuzzy-modify","u",2,2,NULL,(UserDefinedFunction *)fuzzy_modify,"fuzzy_modify",NULL);
   AddUDF(theEnv,"create-fuzzy-value","u",1,UNBOUNDED,NULL,(UserDefinedFunction *)create_fuzzy_value,"create_fuzzy_value",NULL);
   ...
   AddUDF(theEnv,"get-fuzzy-inference-type","w",0,0,NULL,get_fuzzy_inference_type,"get_fuzzy_inference_type",NULL);
...
struct fuzzy_value *fuzzy_union(Environment *theEnv, UDFContext *context, UDFValue *returnValue)
{
   /* TODO: Port from original FuzzyCLIPS */
   returnValue->voidValue = VoidConstant(theEnv);
   return NULL;
...
struct fuzzy_value *fuzzy_intersection(Environment *theEnv, UDFContext *context, UDFValue *returnValue)
{
   /* TODO: Port from original FuzzyCLIPS */
   returnValue->voidValue = VoidConstant(theEnv);
   return NULL;
...
struct fuzzy_value *fuzzy_modify(Environment *theEnv, UDFContext *context, UDFValue *returnValue)
{
   /* TODO: Port from original FuzzyCLIPS */
   returnValue->voidValue = VoidConstant(theEnv);
   return NULL;
...
struct fuzzy_value *create_fuzzy_value(Environment *theEnv, UDFContext *context, UDFValue *returnValue)
{
   /* TODO: Port from original FuzzyCLIPS */
   returnValue->voidValue = VoidConstant(theEnv);
   return NULL;
