...
#include "fuzzyval.h"
   ...
   struct fuzzy_value            *fuzzy_union(Environment *,UDFContext *,UDFValue *);
   struct fuzzy_value            *fuzzy_intersection(Environment *,UDFContext *,UDFValue *);
   struct fuzzy_value            *fuzzy_modify(Environment *,UDFContext *,UDFValue *);
   struct fuzzy_value            *create_fuzzy_value(Environment *,UDFContext *,UDFValue *);
