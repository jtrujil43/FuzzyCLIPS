static char rcsid[] = "$Header: /dist/CVS/fzclips/src/factgen.c,v 1.3 2001/08/11 21:05:34 dave Exp $" ;
...
/****************************************/
   ...
   globle struct entityRecord   FactPNFuzzyValue = {   "FACT_PN_FUZZY_VALUE",
